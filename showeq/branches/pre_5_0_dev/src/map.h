...
enum MapIconType
{
  ...
  tIconTypeDoor = 2, 
  tIconTypeSpawnNPC = 3,
  tIconTypeSpawnNPCCorpse = 4,
  tIconTypeSpawnPlayer = 5, 
  tIconTypeSpawnPlayerCorpse = 6, 
  tIconTypeSpawnUnknown = 7,
  tIconTypeSpawnConsidered = 8,
  tIconTypeSpawnPlayerTeamBase = 9,
  tIconTypeSpawnPlayerTeam1 = 9,
  tIconTypeSpawnPlayerTeam2 = 10,
  tIconTypeSpawnPlayerTeam3 = 11,
  tIconTypeSpawnPlayerTeam4 = 12,
  tIconTypeSpawnPlayerTeam5 = 13,
  tIconTypeSpawnPlayerTeamOtherDeity = 14,
  tIconTypeSpawnPlayerTeamOtherRace = 15,
  tIconTypeSpawnPlayerTeamOtherRacePet = 16,
  tIconTypeSpawnPlayerTeamOtherDeityPet = 17,
  tIconTypeSpawnPlayerOld = 18,
  tIconTypeFilterFlagBase = 19,
  tIconTypeFilterFlagHunt = 19,
  tIconTypeFilterFlagCaution = 20,
  tIconTypeFilterFlagDanger = 21,
  tIconTypeFilterFlagLocate = 22,
  tIconTypeFilterFlagAlert = 23,
  tIconTypeFilterFlagFiltered = 24,
  tIconTypeFilterFlagTracer = 25,
  tIconTypeRuntimeFiltered = 26,
  tIconTypeSpawnPoint = 27,
  tIconTypeNumTypes = 28,
};
...
private:   
   ...
   MapCache m_mapCache;
   MapMenu* m_menu;
   MapIcon m_mapIcons[tIconTypeNumTypes];
   int* m_mapIconSizes[tIconSizeNumSizes];
   int* m_mapIconSizesWH[tIconSizeNumSizes];
